<div>
    <div class="card">
        <div class="card-header text-right">
            <button wire:click="create" class="btn btn-info"><span class="fas fa-plus mr-2"></span>Ekstrakurikuler Baru</button>
        </div>
        <div class="card-body">
    ...
    @include('livewire.ekstrakurikuler.form')
    <x-modal-delete model="Ekstrakurikuler" :name="$nama" />
</div>
